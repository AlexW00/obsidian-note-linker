...
export default class LinkMatchItem implements Renderable {
    ...
    $title(): HTMLElement {
        ...
        title.classList.add("matching-match-item-title");
    ...
    $subTitle(): HTMLElement {
        ...
        subTitle.classList.add("matching-match-item-sub-title");
    ...
    $replacement(): HTMLElement {
        ...
        replacement.classList.add("matching-match-item-replacement");

        const title = document.createElement("span");
        title.classList.add("matching-match-item-replacement-title");
    ...
    $replacementOptions(): HTMLElement {
        ...
        replacementOptions.classList.add("matching-match-item-replacement-options");

        [...aliases, title].forEach((r, i) => {
            const isAlias = r !== title;
            // add a list item with a checkbox on the right side
            const listItem = document.createElement("li");
            listItem.classList.add("matching-match-item-replacement-option");


            const checkbox = document.createElement("input");
            checkbox.type = "checkbox";
            checkbox.value = r;
            checkbox.classList.add("matching-match-item-replacement-checkbox");
            listItem.appendChild(checkbox);

            const replacementText = document.createElement("span");
            replacementText.classList.add("matching-match-item-replacement-option-replacement-text");
            replacementText.innerText = r;
            listItem.appendChild(replacementText);

            const replacementDescription = document.createElement("span");
            replacementDescription.classList.add("matching-match-item-replacement-option-description");
    ...
    $html(): HTMLElement {
        ...
        root.classList.add("matching-match-item");
